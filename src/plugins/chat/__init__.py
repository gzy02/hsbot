...
openai.api_key = config["openai_api_key"]  #key
openai.proxy = config["openai_proxy"]  #代理


async def ask_question(prompt):
    response = await openai.ChatCompletion.acreate(model="gpt-3.5-turbo", messages=prompt)
...
#群组json文件地址
group_number_json_path = "./json_file/group.json"
