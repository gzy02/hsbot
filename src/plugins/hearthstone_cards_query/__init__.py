...
jjc_aomi_query = on_startswith(msg=("jjc奥秘 ", "竞技场奥秘 ", "jjc查奥秘 ", "竞技场查奥秘 ", "jjc猜奥秘 ", "猜奥秘jjc ",
                                    "竞技场猜奥秘 "),
                               priority=3,
                               block=True)
...
jjcCardsSet_query = on_fullmatch(msg=("当前jjc环境", "jjc环境", "当前jjc系列", "jjc系列", "查jjc系列", "查jjc系列",
                                      "查系列jjc", "查系列 jjc"),
                                 priority=1,
                                 block=True)
